"""
Unit tests for ap_master_calibration.calibrate_masters module.
...
from ap_master_calibration.calibrate_masters import generate_masters
...
class TestGenerateMasters:
    ...
    def test_handles_ap_common_exception_gracefully(
        ...
        assert "Failed to discover dark files" in caplog.text
