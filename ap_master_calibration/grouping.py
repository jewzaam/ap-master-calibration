...
def create_group_key(headers: Dict[str, Any], frame_type: str) -> Tuple[str, ...]:
    """
...
def group_files(
    files: List[Dict[str, Any]], frame_type: str
...
def get_group_metadata(headers: Dict[str, Any], frame_type: str) -> Dict[str, str]:
    """
